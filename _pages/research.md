...
Much of my work centers on **scene grammar**—knowledge about where objects tend to appear within structured environments. Traditional approaches frame this as **semantic knowledge** accumulated across a lifetime. However, this makes it difficult to uncover *how* such knowledge forms.

My research explores a complementary account:  
...
**Statistics:** pandas, NumPy, tidyverse, SPSS, JASP  
